...
enum JobCardActionType { apply, viewApplication }
...
class JobCard extends StatelessWidget {
  const JobCard({
    ...
    this.actionType = JobCardActionType.apply,
    this.onShare,
    this.onTap,
    this.onApply,
  ...
  final JobCardActionType actionType;
  final bool isSaved;
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        onTap: onTap ??
            () {
              GoRouter.of(context).push(AppRoutes.kJobDetailsView);
            },
        child: Padding(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  if (actionType == JobCardActionType.apply)
                    ElevatedButton(
                      onPressed: onApply ??
                          () {
                            GoRouter.of(context).push(AppRoutes.kapplyForRole);
                          },
